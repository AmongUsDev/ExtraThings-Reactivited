...
{
    [BepInPlugin(Id, "ExtraThings Reactivited", Version)]
    ...
    public class ExtraThingsPlugin : BasePlugin
    {
        ...
        class VersionShowerUpdate
        {
            public static void Postfix(VersionShower __instance)
            {
                var text = __instance.text;
                text.text += $"<color=blue>ExtraThing v{ExtraThingsPlugin.Version}";
            ...
            {
                var CHLog = new ManualLogSource("ExtraThings-Reactivited");
                ...
                {
                    CHLog.Log(LogLevel.Error, $"{e.StackTrace}");
                    throw;
                }
            }
        ...
        public static void LoadAssetBundle()
        {
            ...
            byte[] audioBundleRead = assembly.GetManifestResourceStream("ExtraThings.Assets.audioassets").ReadFully();
